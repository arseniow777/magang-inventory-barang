...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-3 [--cell-radius:var(--radius-4xl)] [--cell-size:--spacing(8)] group/calendar in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        today: cn(
          "bg-red-600 dark:bg-red-500 text-stone-100 hover: rounded-(--cell-radius) ",
