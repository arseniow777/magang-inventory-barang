...
import { IconPhoto, IconVideo, IconHeadphones, IconFileText, IconFileSpreadsheet, IconFileZip, IconUpload, IconX, IconAlertCircle, IconRefreshDot } from "@tabler/icons-react"
                    ...
                    <Alert variant="destructive" className="mt-2 px-2 py-1">
                      ...
                      <AlertAction>
                        <Button
                          ...
                          className="text-muted-foreground size-6 hover:bg-transparent hover:opacity-100"
                        >
                          <IconRefreshDot className="size-3.5" />
                        </Button>
                      </AlertAction>
                    </Alert>
                  )}
