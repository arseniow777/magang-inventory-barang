  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        .fontSize(14)
        .font("Helvetica-Bold")
        .text("BERITA ACARA SERAH TERIMA BARANG INVENTARIS", {
          align: "center",
        });
      doc
        .fontSize(11)
        .font("Helvetica")
        .text(`Nomor: ${reportNumber}`, { align: "center" });
      doc.moveDown(0.5);
      ...
      doc.text(`Tanggal Permohonan`, 60, doc.y, {
        continued: true,
        width: 150,
      });
      doc.text(`: ${new Date(request.created_at).toLocaleDateString("id-ID")}`);
      doc.text(`Tanggal Persetujuan`, 60, doc.y, {
        continued: true,
        width: 150,
      });
      doc.text(
      ...
      if (request.destination_location) {
        ...
        doc.text(
          `: ${request.destination_location.building_name} - Lantai ${request.destination_location.floor}`,
        );
      }
      doc.moveDown(1);
      ...
      doc
        .fontSize(11)
        .font("Helvetica-Bold")
        .text("III.  DAFTAR BARANG YANG DISERAHTERIMAKAN");
      doc.moveDown(0.5);
      ...
      doc
        .fontSize(10)
        .font("Helvetica")
        .text(`Alasan/Keperluan: ${request.reason}`, 50, yPos, {
          align: "justify",
          width: 500,
        });
      yPos += 40;
      ...
      doc
        .fontSize(10)
        .font("Helvetica")
        .text("Mengetahui & Menyetujui,", 370, yPos);
      ...
      doc
        .fontSize(9)
        .font("Helvetica")
        .text(`(${request.pic.role.toUpperCase()})`, 60, yPos + 14);
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text(request.admin.name, 370, yPos);
      doc
        .fontSize(9)
        .font("Helvetica")
        .text(`(${request.admin.role.toUpperCase()})`, 370, yPos + 14);
